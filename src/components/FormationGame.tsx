      ...
      <AnimatePresence>
        {isStageTransition && (
          <motion.div
            ...
            className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-purple-600 text-white"
          >
            <Sparkles size={120} className="mb-6 animate-pulse" />
            <h2 className="text-6xl font-black mb-2">مذهل!</h2>
            <p className="text-2xl">تحدي جديد في المرحلة {stage + 1}</p>
          </motion.div>
        )}
      </AnimatePresence>
